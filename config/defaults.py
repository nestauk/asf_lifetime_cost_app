...
ASHP_HEAT_DEMAND_UPLIFT_DEFAULT = 0  # %
ASHP_HEAT_DEMAND_UPLIFT_MIN = 0
ASHP_HEAT_DEMAND_UPLIFT_MAX = 20
...
ASHP_LIFESPAN_MIN = 10
ASHP_LIFESPAN_MAX = 25
...
BOILER_LIFESPAN_MIN = 10
BOILER_LIFESPAN_MAX = 25
