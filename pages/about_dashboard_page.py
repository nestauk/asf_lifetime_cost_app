...
def about_dashboard_page():
    ...
    st.markdown(
        ...
        - **The upfront cost of installation**: We have tested two different trajectories where upfront costs fall by 2.5% and 4.5% each year.

        **The level of government subsidy**: In all our scenarios the existing £7,500 subsidy remains until at least 2028 before gradually reducing at different rates.

        **The cost of electricity relative to gas**: A key factor in the cost of electricity and gas is the levies, which are currently higher on electricity than gas. All of our scenarios involve rebalancing the levies away from electricity and towards gas to different extents.
        ...
        **The interest rate for financing a heat pump**: Our analysis assumes all households will purchase heat pumps on finance, with 5% interest rates. Even where households do not use finance, the interest rate reflects the opportunity cost of not investing the money elsewhere.
        ...
        We also present outcomes for an ‘average’ household, defined as the weighted average according to how these archetypes are represented in the English housing stock.
        """
    )
